namespace XamlBrewer.Uwp.LexDbSample.ViewModels
{
    ...
    internal class VintageMuscleCarViewModel : ViewModelBase
    {
        private VintageMuscleCar model;
        private ImageSource picture = null;
        private DelegateCommand uploadImageCommand;

        public VintageMuscleCarViewModel(VintageMuscleCar model)
        {
            this.model = model;
